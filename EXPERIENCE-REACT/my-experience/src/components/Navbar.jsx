...
export const Navbar = () => {
  ...
  return (
    <div className='absolute  w-full flex justify-between p-4 items-center'>
        ...
        <HiMenuAlt3 onClick={handleNav} className='text-white font-bold z-20 cursor-pointer' size={25}/>
        <div className={
            nav ? 'ease-in duration-300 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 py-7 flex-col z-10'
            : 'absolute top-0 h-screen left-[-100%] ease-in duration-500 z-10' 
        }
        >
            <ul className='flex flex-col fixed font-bold w-full h-full items-center justify-center'>
